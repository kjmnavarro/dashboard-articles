...
@section('title', "Editor's All Media")
...
<div class="container-fluid mt-3">
    ...
    <x-adminlte-datatable id="editormain" head-theme="dark" :heads="$heads" :config="$config">
        @foreach($articles as $article)
            <tr>
                <td>
                    @if (Auth::user()->can('edit-articles', $article))
                        <a href="{{ route('editors.edit', Crypt::encrypt($article)) }}" class="btn btn-xs btn-default text-primary mx-1"><i class="fa fa-lg fa-fw fa-pen"></i></a>
                    @else
                        -
                    @endif
                </td>
