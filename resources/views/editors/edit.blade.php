...
<div class="container">
    ...
    <form action="{{ route('editors.update', Crypt::encrypt($article)) }}">
        ...
        <button type="submit" class="btn btn-lg btn-info" name="action" value="save">Save Article</button>
        <button type="submit" class="btn btn-lg btn-success" name="action" value="publish">Publish Article</button>
    </form>
</div>
@endsection
